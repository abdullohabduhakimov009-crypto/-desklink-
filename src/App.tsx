    ...
    const initGlobe = (initialWidth: number) => {
      ...
      globeRef.current = createGlobe(canvasRef.current, {
        ...
        markers: [
          ...
          // Additional to reach ~91 countries representation
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                <span className="text-[10px] uppercase tracking-widest text-white/30 font-bold px-2">Language</span>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-xl font-bold text-brand-teal relative z-10"><Counter value="91" /></p>
                  </motion.div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-8 mb-20 max-w-3xl mx-auto">
                ...
                <div>
                  <div className="text-5xl md:text-6xl font-bold text-brand-teal mb-3 tracking-tighter"><Counter value="91" /></div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            { icon: Globe, title: t.capabilities.network, desc: t.capabilities.networkDesc, stat: '91', statLabel: 'countries covered' },
      ...
      if (user) {
        ...
        unsubscribe = onSnapshot(userRef, (docSnap) => {
          if (docSnap.exists()) {
            ...
            else if (data.role === 'engineer') setEngineerData(data);
