              ...
              <div className="space-y-8">
                ...
                {step === 4 && (
                  <div className="space-y-8">
                    ...
                    <div className="group">
                      <label htmlFor="bio-input" className="block text-sm font-bold text-slate-500 uppercase tracking-widest mb-3">
                        Bio / About Me
                      </label>
                      <div className="flex gap-4">
                        <div className="w-14 h-14 bg-slate-100 border border-slate-200 rounded-2xl flex items-center justify-center shrink-0" aria-hidden="true">
                        ...
                        <textarea 
                          ...
                          className="flex-1 bg-white border border-slate-200 rounded-2xl p-6 text-lg text-slate-900 outline-none focus-visible:ring-2 focus-visible:ring-brand-teal transition-all placeholder:text-slate-300 h-40 resize-none" 
                        />
                      </div>
                    </div>
                  </div>
