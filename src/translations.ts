...
export const translations = {
  en: {
    ...
    hero: {
      ...
      subtitle: "Connect with verified engineers from 91 countries. Build your dream team in days, not months.",
    ...
    capabilities: {
      ...
      networkDesc: "Access verified engineers across 91 countries, all time zones covered, 24/7 support.",
    ...
    footer: {
      desc: "Global platform connecting innovative companies with verified IT talent from 91 countries.",
      product: "Product",
      company: "Company",
      legal: "Legal",
...
6. Your Rights: You have the right to access, correct, or delete your personal information at any time through your account settings.`
    ...
    why: {
      ...
      comparison: {
        ...
        rows: [
          ...
          ["Global Reach", "91 Countries", "Regional"],
          ["Support Response", "< 2 hours", "24-48 hours"]
        ]
      },
      networkTitle: "Truly",
      networkTitleAccent: "Global Network",
      networkSubtitle: "Access top-tier IT talent from 91 countries with experience across all major tech stacks.",
      networkStats: [
        { label: "Engineers", value: "3,500+" },
        { label: "Companies", value: "35+" },
        { label: "Countries", value: "91" },
    ...
    clientPortal: {
      ...
      services: {
        ...
        coverage: {
          ...
          desc: "We provide services in 91 countries with a network of 20,000+ certified engineers.",
    ...
    settings: {
      ...
      notifDesc: "Control how and when you receive updates from the DeskLink platform.",
  ...
  ru: {
    ...
    hero: {
      ...
      subtitle: "Свяжитесь с проверенными инженерами из 91 стран. Создайте команду своей мечты за считанные дни, а не месяцы.",
    ...
    capabilities: {
      ...
      networkDesc: "Доступ к проверенным инженерам в 91 странах, охват всех часовых поясов, поддержка 24/7.",
...
6. Ваши права: Вы имеете право на доступ, исправление или удаление вашей личной информации в любое время через настройки вашей учетной записи.`
    ...
    why: {
      ...
      comparison: {
        ...
        rows: [
          ...
          ["Глобальный охват", "91 Страна", "Региональный"],
          ["Ответ поддержки", "< 2 часов", "24-48 часов"]
        ]
      },
      networkTitle: "По-настоящему",
      networkTitleAccent: "Глобальная сеть",
      networkSubtitle: "Доступ к высококлассным IT-талантам из 91 стран с опытом работы во всех основных технологических стеках.",
      networkStats: [
        { label: "Инженеры", value: "3,500+" },
        { label: "Компании", value: "35+" },
        { label: "Страны", value: "91" },
        { label: "Uptime", value: "99.9%" }
      ],
    ...
    clientPortal: {
      ...
      services: {
        ...
        coverage: {
          ...
          desc: "Мы предоставляем услуги в 91 странах с сетью из 20 000+ сертифицированных инженеров.",
    ...
    settings: {
      ...
      bio: "Биография / Профессиональное резюме",
      bioPlaceholder: "Расскажите нам немного о себе...",
      ...
      notifDesc: "Управляйте тем, как и когда вы получаете обновления от платформы DeskLink.",
  ...
  uz: {
    ...
    hero: {
      ...
      subtitle: "91 ta mamlakatdan kelgan tasdiqlangan muhandislar bilan bog'laning. Orzuingizdagi jamoani oylar emas, kunlar ichida quring.",
    ...
    capabilities: {
      ...
      networkDesc: "91 ta mamlakatdagi tasdiqlangan muhandislarga kirish, barcha vaqt zonalari qamrab olingan, 24/7 qo'llab-quvvatlash.",
...
6. Sizning huquqlaringiz: Siz istalgan vaqtda hisob sozlamalari orqali shaxsiy ma'lumotlaringizga kirish, ularni tuzatish yoki o'chirish huquqiga egasiz.`
    ...
    why: {
      ...
      comparison: {
        ...
        rows: [
          ...
          ["Global qamrov", "91 ta Mamlakatlar", "Mintaqaviy"],
          ["Yordam javobi", "< 2 soat", "24-48 soat"]
        ]
      },
      networkTitle: "Haqiqatdan ham",
      networkTitleAccent: "Global tarmoq",
      networkSubtitle: "Barcha asosiy texnologik steklar bo'yicha tajribaga ega 91 ta mamlakatdan yuqori darajadagi IT iste'dodlariga kiring.",
      networkStats: [
        { label: "Muhandislar", value: "3,500+" },
        { label: "Kompaniyalar", value: "35+" },
        { label: "Mamlakatlar", value: "91" },
        { label: "Uptime", value: "99.9%" }
      ],
    ...
    clientPortal: {
      ...
      services: {
        ...
        coverage: {
          title: "Global qamrov",
          desc: "Biz 91 ta mamlakatda 20 000 dan ortiq sertifikatlangan muhandislar tarmog'i bilan xizmat ko'rsatamiz.",
    ...
    settings: {
      ...
      bio: "Bio / Professional xulosa",
      bioPlaceholder: "O'zingiz haqingizda bir oz gapirib bering...",
      ...
      notifDesc: "DeskLink platformasidan yangilanishlarni qanday va qachon olishingizni nazorat qiling.",
